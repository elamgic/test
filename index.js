...
client.on('ready', () => {
  client.user.setGame(` By @!Gn ,                ❤fяɪєиcє❣#2949  .`,'https://www.twitch.tv/v5bz');
  console.log('---------------');
...
client.login("NTQxMjk1NTMxNDgyMTUyOTYw.DzdhMw.Al7wna25DEamzXaQ9Ng7hkT_enY");